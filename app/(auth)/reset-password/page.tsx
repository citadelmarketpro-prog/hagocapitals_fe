...
export default function ResetPasswordPage() {
 return (
 <Suspense fallback={<AuthLayout><div className="h-40" /></AuthLayout>}>
...
function ResetPasswordContent() {
 ...
 <div className="w-12 h-12 rounded-full bg-[#fef2f2] flex items-center justify-center text-[#dc2626]">
 <AlertIcon />
 </div>
 ...
 className="mt-2 flex items-center justify-center h-[46px] text-[14px] font-bold text-white transition-opacity hover:opacity-90"
 ...
 <Link
 href="/sign-in"
 className="flex items-center justify-center gap-1.5 text-[13px] text-[#666666] hover:text-[#001011] transition-colors"
 >
 <ArrowLeftIcon />
 Back to Sign In
 </Link>
 ...
 className="mt-2 h-[46px] rounded-full text-[14px] font-bold text-white transition-opacity hover:opacity-90"
 style={{ backgroundColor: "#06811d" }}
 >
 Sign In
 </button>
 ...
 className="w-full h-[46px] border border-[#e5e5e5] bg-white px-4 pr-11 text-[14px] text-[#001011] placeholder-[#aaaaaa] outline-none focus:border-[#06811d] transition-colors"
 />
 <button
 type="button"
 ...
 className={[
 "w-full h-[46px] border bg-white px-4 pr-11 text-[14px] text-[#001011] placeholder-[#aaaaaa] outline-none transition-colors",
 password2.length > 0 && !passwordsMatch
 ? "border-[#dc2626]"
 : "border-[#e5e5e5] focus:border-[#06811d]",
 ].join(" ")}
 />
 <button
 type="button"
