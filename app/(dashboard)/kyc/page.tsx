            ...
            <div className="flex items-center justify-end gap-3 mt-10 pt-6 border-t border-[#f0f0ec] dark:border-[#1e3827]">
              {step > 1 && (
                <button
                  ...
                  className="h-11 px-8 rounded-full border border-[#d4d4d4] dark:border-[#2a4a34] text-[14px] font-medium text-[#001011] dark:text-white hover:bg-[#f5f5f5] dark:hover:bg-[#132b1a] transition-colors"
                >
                  Back
                </button>
              )}
      ...
      <FieldRow num={7} label="Upload ID Documents">
        <div className="grid grid-cols-2 gap-3">
          ...
          <button
            ...
            className="flex flex-col items-center justify-center h-24 border-2 border-dashed border-[#d4d4d4] dark:border-[#2a4a34] bg-[#fafaf7] dark:bg-[#0b1c11] hover:border-[#0c5c45] dark:hover:border-[#34d399] hover:bg-[#eaf5f0] dark:hover:bg-[#0e2016] transition-all gap-1.5 rounded-2xl"
          >
            {form.id_front ? (
              <>
...
function FieldRow({ num, label, children }: { num: number; label: string; children: React.ReactNode }) {
  return (
    <div className="flex gap-4 items-start">
      <div className="w-7 h-7 rounded-full bg-[#0c5c45]/20 dark:bg-[#1a3020] border border-[#0c5c45]/40 dark:border-[#2a4a20] flex items-center justify-center text-[11px] font-bold text-[#0c5c45] dark:text-[#34d399] shrink-0 mt-[30px]">
        {num}
      </div>
...
function KycInput({
  ...
  return (
    <input
      ...
      className="w-full h-12 px-4 bg-[#f8f8f4] dark:bg-[#0b1c11] border border-[#e5e5e0] dark:border-[#1e3827] focus:border-[#0c5c45] dark:focus:border-[#34d399] focus:bg-white dark:focus:bg-[#0e1e14] text-[14px] text-[#001011] dark:text-white placeholder-[#bbbbbb] dark:placeholder-[#3a5040] outline-none transition-all"
    />
  );
}
  ...
  return (
    <div className="relative">
      <select
        value={value}
        onChange={(e) => onChange(e.target.value)}
        className="w-full h-12 px-4 pr-10 bg-[#f8f8f4] dark:bg-[#0b1c11] border border-[#e5e5e0] dark:border-[#1e3827] focus:border-[#0c5c45] dark:focus:border-[#34d399] focus:bg-white dark:focus:bg-[#0e1e14] text-[14px] text-[#001011] dark:text-white outline-none appearance-none transition-all cursor-pointer"
      >
    ...
    <div className="lg:sticky lg:top-18 self-start space-y-4">
      ...
      <div className="bg-[#f5fce8] dark:bg-[#0e2016] border border-[#d4e8a0] dark:border-[#1e3827] p-4">
        <p className="text-[12px] text-[#445520] dark:text-[#8fa896] leading-relaxed">
          ...
          <span className="text-[#0c5c45] dark:text-[#34d399] underline cursor-pointer font-medium">Terms of Service</span>
          {" "}and{" "}
          <span className="text-[#0c5c45] dark:text-[#34d399] underline cursor-pointer font-medium">Privacy Policy</span>.
        </p>
      </div>
    </div>
  );
