...
function SkeletonCard({ width = "min-w-[280px] max-w-[280px]" }: { width?: string }) {
  return (
    <div className={`${width} shrink-0 bg-white dark:bg-[#0e1e14] border border-[#e5e5e5] dark:border-[#1e3827] overflow-hidden animate-pulse`}>
      <div className="p-4 flex items-center gap-3">
        <div className="w-10 h-10 rounded-full bg-[#e5e5e5] dark:bg-[#1a2a1e] shrink-0" />
        <div className="flex-1 space-y-2">
          <div className="h-3.5 bg-[#e5e5e5] dark:bg-[#1a2a1e] rounded w-3/4" />
          <div className="h-3 bg-[#e5e5e5] dark:bg-[#1a2a1e] rounded w-1/2" />
        </div>
      </div>
      <div className="mx-4 mb-3 bg-[#f5f5ef] dark:bg-[#0b1a10] px-4 py-3 flex items-center justify-between">
        <div className="space-y-1.5">
          <div className="h-4 bg-[#e5e5e5] dark:bg-[#1a2a1e] rounded w-16" />
          <div className="h-3 bg-[#e5e5e5] dark:bg-[#1a2a1e] rounded w-12" />
        </div>
        <div className="space-y-1.5">
          <div className="h-4 bg-[#e5e5e5] dark:bg-[#1a2a1e] rounded w-12" />
          <div className="h-3 bg-[#e5e5e5] dark:bg-[#1a2a1e] rounded w-10" />
        </div>
      </div>
      <div className="px-4 pb-4">
        <div className="h-10 bg-[#e5e5e5] dark:bg-[#1a2a1e] rounded" />
      </div>
    </div>
  );
}
    ...
    <section className="py-6">
      <div className="flex items-start justify-between gap-4 mb-4">
        <div className="space-y-2 animate-pulse">
          <div className="h-5 bg-[#e5e5e5] dark:bg-[#1a2a1e] rounded w-48" />
          <div className="h-3 bg-[#e5e5e5] dark:bg-[#1a2a1e] rounded w-72" />
        </div>
      </div>
    ...
    <>
      ...
      <section className="py-6 animate-pulse">
        <div className="space-y-2 mb-5">
          <div className="h-5 bg-[#e5e5e5] dark:bg-[#1a2a1e] rounded w-56" />
          <div className="h-3 bg-[#e5e5e5] dark:bg-[#1a2a1e] rounded w-80" />
        </div>
        <div className="flex gap-2 mb-5">
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="h-8 w-20 bg-[#e5e5e5] dark:bg-[#1a2a1e] rounded-full shrink-0" />
          ))}
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-8">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="flex items-center gap-3 py-3 border-b border-[#f0f0ec] dark:border-[#1a2e1e]">
              <div className="w-16 h-12 bg-[#e5e5e5] dark:bg-[#1a2a1e] rounded shrink-0" />
              <div className="flex-1 space-y-1.5">
                <div className="h-3.5 bg-[#e5e5e5] dark:bg-[#1a2a1e] rounded w-3/4" />
                <div className="h-3 bg-[#e5e5e5] dark:bg-[#1a2a1e] rounded w-1/2" />
              </div>
              <div className="space-y-1.5 shrink-0">
                <div className="h-3.5 bg-[#e5e5e5] dark:bg-[#1a2a1e] rounded w-16" />
                <div className="h-3 bg-[#e5e5e5] dark:bg-[#1a2a1e] rounded w-12" />
              </div>
            </div>
          ))}
      ...
      <SkeletonSection title="Reliable Traders" />
      <SkeletonSection title="Proven Stability" />
    </>
  );
}
...
function HeroBanner() {
  return (
    <div className="max-w-[1280px] mx-auto px-4 lg:px-6 py-4">
      <div className="relative flex overflow-hidden" style={{ backgroundColor: "#34d399", minHeight: "140px" }}>
...
function SearchResultCard({ trader }: { trader: Trader }) {
  return (
    <Link href={`/traders/${trader.id}`}>
      <div className="bg-white dark:bg-[#0e1e14] border border-[#e5e5e5] dark:border-[#1e3827] p-4 flex flex-col gap-3 hover:border-[#0c5c45] dark:hover:border-[#34d399] transition-colors cursor-pointer h-full">
  ...
  return (
    <section className="py-6">
      ...
      <div className="relative -mx-4 lg:-mx-6">
        ...
        <button onClick={() => scroll(-1)} className="hidden lg:flex absolute left-0 top-1/2 -translate-y-1/2 w-8 h-8 items-center justify-center rounded-full bg-white dark:bg-[#132b1a] border border-[#e5e5e5] dark:border-[#1e3827] shadow text-[#555555] dark:text-[#8fa896] hover:text-[#001011] dark:hover:text-white transition-colors z-10">
          <ChevronLeftIcon />
        </button>
        <button onClick={() => scroll(1)} className="hidden lg:flex absolute right-0 top-1/2 -translate-y-1/2 w-8 h-8 items-center justify-center rounded-full bg-white dark:bg-[#132b1a] border border-[#e5e5e5] dark:border-[#1e3827] shadow text-[#555555] dark:text-[#8fa896] hover:text-[#001011] dark:hover:text-white transition-colors z-10">
          <ChevronRightIcon />
        </button>
      </div>
    </section>
...
function RisingStarCard({ trader }: { trader: Trader }) {
  return (
    <Link href={`/traders/${trader.id}`} className="block">
      <div className="min-w-[300px] max-w-[300px] bg-white dark:bg-[#0e1e14] border border-[#e5e5e5] dark:border-[#1e3827] flex flex-col shrink-0 overflow-hidden hover:border-[#0c5c45] dark:hover:border-[#34d399] transition-colors">
        ...
        <div className="px-4 pb-4">
          <button className="w-full h-10 rounded-full border border-[#e5e5e5] dark:border-[#1e3827] text-[13px] font-bold text-[#001011] dark:text-white hover:bg-[#f8f8f5] dark:hover:bg-[#132b1a] transition-colors">
            Copy trader
          </button>
        </div>
      </div>
...
function ReliableCard({ trader }: { trader: Trader }) {
  return (
    <Link href={`/traders/${trader.id}`} className="block">
      <div className="min-w-[250px] max-w-[250px] bg-white dark:bg-[#0e1e14] border border-[#e5e5e5] dark:border-[#1e3827] flex flex-col shrink-0 overflow-hidden hover:border-[#0c5c45] dark:hover:border-[#34d399] transition-colors">
        <div className="flex items-center gap-3 px-4 pt-4 pb-3">
          <div className="w-[52px] h-[52px] rounded-full bg-[#f0f0ec] dark:bg-[#1a2a1e] flex items-center justify-center shrink-0">
            <TraderAvatar trader={trader} size="sm" />
          </div>
